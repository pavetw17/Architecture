...
<%-- <c:if test="${not empty sessionScope.tbl_qt.user_admin}">
	<% 
	 response.sendRedirect("../showTinTuc?action=events"); 
	%> 
</c:if> --%>
	...
	<form method="post" action="../DangNhap" onsubmit="return kiemtra_dangnhap();">
		<div id="background">
			...
			<div id="Usernameinput">
				<input class="textbox" type="text" name="txt_username" value=""
					id="txt_username" />
			</div>
			<div id="Password">Password</div>
			<div id="Passwordinput">
				<input class="textbox" type="password" name="txt_password" value=""
					id="txt_password" />
			</div>
