...
<script type="text/javascript"	src="<%=request.getContextPath()%>/admin/template/alert/jquery.alerts.js"></script>
<link rel="stylesheet" href="<%=request.getContextPath()%>/admin/template/alert/jquery.alerts.css" type="text/css" />
     ...
     // var limit = Math.min((page_index+1) * items_per_page, bandau); //so dong
      ...
      $.post( "/eventweb/Highlights_TimTin", {
      	action: 'list',
			...
			txt_language : $('input[name=txt_language]:checked').val(),
      	offset: offset,
  	    limit: limit
      }, function(newcontent){	 
...
<table style="width: 100%;">
	...
	<table cellpadding="4" cellspacing="0" width="100%"
		...
		<tr>
			<td width="19%" align="right">Language:</td>
			<td width="2%">&nbsp;</td>
			<td width="20%"><input type="radio" value="1" checked id="txt_language" name="txt_language" style="width: 24; height: 24;"><img src="images/VietNam.png" title="Tiếng Việt"/>
			<input type="radio" name="txt_language" value="2" id="txt_language" style=" width: 24; height: 24; margin-left: 40px;"><img src="images/UnitedKingdom.png" title="English" /></td>
		</tr>
		<tr>
